...
// MARK: - ProductDetatilsDto

enum OptionDescriptionNameEnum: String, Codable {
    case color = "Color"
    case size = "Size"
}
...
class ProductDetatilsDto: Codable {
    ...
    init(status: Bool, productDetails: [ProductDetail], aditionalImages: [AditionalImage], options: [Option], relatedProducts: [RelatedProduct], rating: String, stars: Stars, review: [Review]) {
        self.status = status
        self.productDetails = productDetails
        self.aditionalImages = aditionalImages
        self.options = options
...
class AditionalImage: Codable {
    ...
    init(productImageID: Int?, productID: Int, image: String, sortOrder: Int?, type: String?) {
        self.productImageID = productImageID
        self.productID = productID
        self.image = image
        self.sortOrder = sortOrder
...
// MARK: - Option
class Option: Codable {
    let optionDescriptionName, optionValueDescriptionName, optionValueImage, optionType: String
    let productOptionValueID, productOptionID, productID, optionID: Int
    let optionValueID, quantity, subtract: Int
    let price, pricePrefix: String
    let points: Int
    let pointsPrefix, weight, weightPrefix: String
    ...
    init(optionDescriptionName: String, optionValueDescriptionName: String, optionValueImage: String, optionType: String, productOptionValueID: Int, productOptionID: Int, productID: Int, optionID: Int, optionValueID: Int, quantity: Int, subtract: Int, price: String, pricePrefix: String, points: Int, pointsPrefix: String, weight: String, weightPrefix: String) {
        self.optionDescriptionName = optionDescriptionName
        self.optionValueDescriptionName = optionValueDescriptionName
        self.optionValueImage = optionValueImage
...
// MARK: - ProductDetail
class ProductDetail: Codable {
    let productID, model, sku, upc: String
    let ean, jan, isbn, mpn: String
    let location, quantity, stockStatusID, image: String
    let manufacturerID, shipping, price, points: String
    let taxClassID, dateAvailable, weight, weightClassID: String
    let length, width, height, lengthClassID: String
    let subtract, minimum, sortOrder, status: String
    let viewed, dateAdded, dateModified, languageID: String
    let name, productDetailDescription, tag, metaTitle: String
    let metaDescription, metaKeyword, discountPrice: String
    ...
    init(productID: String, model: String, sku: String, upc: String, ean: String, jan: String, isbn: String, mpn: String, location: String, quantity: String, stockStatusID: String, image: String, manufacturerID: String, shipping: String, price: String, points: String, taxClassID: String, dateAvailable: String, weight: String, weightClassID: String, length: String, width: String, height: String, lengthClassID: String, subtract: String, minimum: String, sortOrder: String, status: String, viewed: String, dateAdded: String, dateModified: String, languageID: String, name: String, productDetailDescription: String, tag: String, metaTitle: String, metaDescription: String, metaKeyword: String, discountPrice: String) {
        self.productID = productID
        self.model = model
        self.sku = sku
        self.upc = upc
...
// MARK: - Stars
class Stars: Codable {
    let fiveStar, fourStar, threeStar, twoStar: Int
    let singleStar: Int
    
    init(fiveStar: Int, fourStar: Int, threeStar: Int, twoStar: Int, singleStar: Int) {
